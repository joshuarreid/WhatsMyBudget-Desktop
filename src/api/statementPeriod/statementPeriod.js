...
/**
 * generateOptions
 * Generates a list of month-year options surrounding the anchor.
 *
 * @function generateOptions
 * @param {Object} [params={}]
 * @param {Date} [params.anchor=new Date()] - Date to anchor the options.
 * @param {number} [params.prev=1] - Number of months before anchor.
 * @param {number} [params.forward=5] - Number of months after anchor.
 * @returns {Array<{label: string, value: string, iso: string, offset: number}>} Array of options.
 */
 ...
 * @returns {Object|null} Current option object or null if none found.
 */
